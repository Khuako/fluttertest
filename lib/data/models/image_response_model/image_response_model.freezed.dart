...
mixin _$ImageResponseModel {
  ...
  ImagesModel? get result => throw _privateConstructorUsedError;
...
abstract class $ImageResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? ok, ImagesModel? result});

  $ImagesModelCopyWith<$Res>? get result;
}
...
class _$ImageResponseModelCopyWithImpl<$Res, $Val extends ImageResponseModel>
  ...
  $ImagesModelCopyWith<$Res>? get result {
    ...
    return $ImagesModelCopyWith<$Res>(_value.result!, (value) {
...
class _$ImageResponseModelImpl implements _ImageResponseModel {
  _$ImageResponseModelImpl({this.ok, this.result});
  ...
  final bool? ok;
  @override
  final ImagesModel? result;

  @override
  String toString() {
    return 'ImageResponseModel(ok: $ok, result: $result)';
  }
...
abstract class _ImageResponseModel implements ImageResponseModel {
  factory _ImageResponseModel({final bool? ok, final ImagesModel? result}) =
